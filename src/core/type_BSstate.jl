...
#function BSstate(clusters::Vector{MOCluster}, 
#        p_spaces::Vector{TPSChem.ClusterSubspace}, 
#        q_spaces::Vector{TPSChem.ClusterSubspace}; T=Float64, R=1) 
#    #={{{=#
#
#    N = length(clusters)
...
"""
    +(ts1::TPSChem.BSstate, ts2::TPSChem.BSstate)
"""
...
"""
    add!(ts1::TPSChem.BSstate, ts2::TPSChem.BSstate)
...
"""
    overlap(ts1::TPSChem.BSstate, ts2::TPSChem.BSstate)
