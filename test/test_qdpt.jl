...
cluster_bases = TPSChem.compute_cluster_eigenbasis_spin(ints, clusters, d1, [3,3,3,3,3], init_fspace, max_roots=M, verbose=1);
...
e2a = TPSChem.compute_pt2_energy(v, cluster_ops, clustered_ham)
e_qdpt=TPSChem.compute_qdpt_energy(v, cluster_ops, clustered_ham, nbody=4, H0="Hcmf",  thresh_foi=1e-8,  verbose=1, threaded=true)
