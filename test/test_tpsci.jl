...
@testset "tpsci he 64bit" begin
    ...
    #e0, v0 = TPSChem.tpsci_ci(ci_vector, cluster_ops, clustered_ham, incremental=false,
    #                          thresh_cipsi=1e-2, thresh_foi=1e-4, thresh_asci=1e-2, conv_thresh=1e-4);
    e0, v0 = TPSChem.tpsci_ci(ci_vector, cluster_ops, clustered_ham, incremental=true, ci_conv=1e-10,
                              thresh_cipsi=1e-3, thresh_foi=1e-8, thresh_asci=-1, conv_thresh=1e-7, ci_lindep_thresh=1e-12);
    
    if true
        H = TPSChem.build_full_H(v0, cluster_ops, clustered_ham)
        sig1 = H*TPSChem.get_vector(v0)
        sig2 = TPSChem.tps_ci_matvec(v0, cluster_ops, clustered_ham)
        ...
        e0b, v0b = TPSChem.tps_ci_direct(guess, cluster_ops, clustered_ham, conv_thresh=1e-10);
        e0c, v0c = TPSChem.tps_ci_davidson(guess, cluster_ops, clustered_ham, conv_thresh=1e-9, precond=false, max_iter=200, lindep_thresh=1e-14);
        e0d, v0d = TPSChem.tps_ci_davidson(guess, cluster_ops, clustered_ham, conv_thresh=1e-9, precond=true, max_iter=200, lindep_thresh=1e-14);
    ...
    e2 = TPSChem.compute_pt2_energy(v0, cluster_ops, clustered_ham, thresh_foi=1e-10)
    ...
    e2a, v1a = TPSChem.compute_pt1_wavefunction(v0, cluster_ops, clustered_ham, thresh_foi=1e-8)
...
@testset "tpsci h12 64bit" begin
    ...
    #e0, v0 = TPSChem.tpsci_ci(ci_vector, cluster_ops, clustered_ham, incremental=false,
    #                          thresh_cipsi=1e-2, thresh_foi=1e-4, thresh_asci=1e-2, conv_thresh=1e-4);
    e0, v0 = TPSChem.tpsci_ci(ci_vector, cluster_ops, clustered_ham, incremental=true, ci_conv=1e-8,
...
@testset "tpsci h12 32bit" begin
    ...
    #
    # form Cluster data
    cluster_bases = TPSChem.compute_cluster_eigenbasis(ints, clusters, verbose=1, 
                                                       max_roots=max_roots, 
    ...
    ref_fock = TPSChem.FockConfig(init_fspace)
    ci_vector = TPSChem.TPSCIstate(clusters, ref_fock, R=nroots, T=Float32)
    ...
    #e0, v0 = TPSChem.tpsci_ci(ci_vector, cluster_ops, clustered_ham, incremental=false,
    #                          thresh_cipsi=1e-2, thresh_foi=1e-4, thresh_asci=1e-2, conv_thresh=1e-4);
    e0, v0 = TPSChem.tpsci_ci(ci_vector, cluster_ops, clustered_ham, incremental=true,
                              thresh_cipsi=1e-2, thresh_foi=1e-4, thresh_asci=1e-2, conv_thresh=1e-4);
    
    e2 = TPSChem.compute_pt2_energy(v0, cluster_ops, clustered_ham, thresh_foi=1e-8)
